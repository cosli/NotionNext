const CONFIG = {
  ...
  NOTICE_BAR: [
    { title: '代理商注册教程', url: 'https://hjkk.top/dlszc' },
    { title: '优选好卡直接办', url: 'https://hjkk.top/yxhk' },
    { title: '进店挑选', url: 'https://haokawx.lot-ml.com/Product/Index/117092' }
  ],

  // 英雄区(首页顶部大卡)
  HERO_TITLE_1: '黄金卡卡',
  HERO_TITLE_2: '善良且值得信赖',
  HERO_TITLE_3: 'HJKK.TOP',
  HERO_TITLE_4: '每日更新',
  HERO_TITLE_5: '优选好卡直接办',
  HERO_TITLE_LINK: 'https://hjkk.top/yxhk',

  // 英雄区显示三个置顶分类
  HERO_CATEGORY_1: { title: '优选好卡', url: '/tag/优选好卡' },
  HERO_CATEGORY_2: { title: '代理教程', url: '/tag/代理教程' },
  HERO_CATEGORY_3: { title: '厚积薄发', url: '/tag/厚积薄发' },
  ...
  INFO_CARD_URL: 'https://hjkk.top/about', // 个人资料底部按钮链接
  ...
  SOCIAL_CARD_URL: 'https://hjkk.top/jlpd',
